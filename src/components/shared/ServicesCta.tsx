...
/**
 * Фінальний "розгалужений" заклик до дії, що ставиться перед футером на
 * головних сторінках. Проєктування подається як фокус (бейдж + контрастна
 * кнопка), будівництво — як рівноцінний, повністю реалізований напрямок
 * (видима окреслена кнопка, а не приглушений текстовий лінк).
 */
      ...
      <Container maxWidth="md">
        ...
        >
          ...
          <Stack
            ...
            direction="row"
            spacing={1}
            sx={{ alignItems: "center", opacity: 0.85 }}
          >
            <Typography variant="body2">{t("helper")}</Typography>
            <Button
              component={Link}
              href="/configurator"
              variant="text"
              ...
              sx={{ textTransform: "none", fontWeight: 600, "&:hover": { bgcolor: "transparent" } }}
            >
              {t("helperCta")}
            </Button>
          </Stack>
